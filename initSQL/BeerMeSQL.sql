...
--
-- Table structure for table `BOISSON_ABONNEMENT`
--

DROP TABLE IF EXISTS `BOISSON_ABONNEMENT`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `BOISSON_ABONNEMENT` (
  `idBOISSON_ABONNEMENT` int(11) NOT NULL AUTO_INCREMENT,
  `FK_idBOISSON` int(11) NOT NULL,
  `FK_idABONNEMENT` int(11) NOT NULL,
  PRIMARY KEY (`idBOISSON_ABONNEMENT`),
...
--
-- Table structure for table `BOISSON_CARTONCADEAU`
--

DROP TABLE IF EXISTS `BOISSON_CARTONCADEAU`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `BOISSON_CARTONCADEAU` (
  `idBOISSON_CARTONCADEAU` int(11) NOT NULL AUTO_INCREMENT,
  `FK_idBOISSON` int(11) NOT NULL,
  `FK_idCARTONCADEAU` int(11) NOT NULL,
  PRIMARY KEY (`idBOISSON_CARTONCADEAU`),
  KEY `FK_BOISSONCARTONCADEAU_idx` (`FK_idBOISSON`),
  KEY `FK_CARTONCADEAUBOISSON_idx` (`FK_idCARTONCADEAU`),
  CONSTRAINT `FK_BOISSONCARTONCADEAU` FOREIGN KEY (`FK_idBOISSON`) REFERENCES `BOISSON` (`idBOISSON`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_CARTONCADEAUBOISSON` FOREIGN KEY (`FK_idCARTONCADEAU`) REFERENCES `CARTONCADEAU` (`idCARTONCADEAU`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `CARTONCADEAU_PANIER`
--

DROP TABLE IF EXISTS `CARTONCADEAU_PANIER`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CARTONCADEAU_PANIER` (
  `idCARTONCADEAU_PANIER` int(11) NOT NULL AUTO_INCREMENT,
  `CARTONCADEAU_PANIERcol` varchar(45) DEFAULT NULL,
  `FK_idPANIER` int(11) NOT NULL,
  `FK_idCARTONCADEAU` int(11) NOT NULL,
  PRIMARY KEY (`idCARTONCADEAU_PANIER`),
...
DROP TABLE IF EXISTS `PANIER_ABONNEMENT`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `PANIER_ABONNEMENT` (
  `idPANIER_ABONNEMENT` int(11) NOT NULL AUTO_INCREMENT,
  `FK_idPANIER` int(11) NOT NULL,
  `FK_idABONNEMENT` int(11) NOT NULL,
  PRIMARY KEY (`idPANIER_ABONNEMENT`),
...
--
-- Table structure for table `PANIER_APERO`
--

DROP TABLE IF EXISTS `PANIER_APERO`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `PANIER_APERO` (
  `idPANIER_APERO` int(11) NOT NULL AUTO_INCREMENT,
  `FK_idPANIER` int(11) NOT NULL,
  `FK_idAPERO` int(11) NOT NULL,
  PRIMARY KEY (`idPANIER_APERO`),
...
--
-- Table structure for table `PANIER_BOISSON`
--

DROP TABLE IF EXISTS `PANIER_BOISSON`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `PANIER_BOISSON` (
  `idPANIER_BOISSON` int(11) NOT NULL AUTO_INCREMENT,
  `FK_idPANIER` int(11) NOT NULL,
  `FK_idBOISSON` int(11) NOT NULL,
  PRIMARY KEY (`idPANIER_BOISSON`),
...
--
-- Table structure for table `TYPEAPERO_BOISSON`
--

DROP TABLE IF EXISTS `TYPEAPERO_BOISSON`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `TYPEAPERO_BOISSON` (
  `idTYPEAPERO_BOISSON` int(11) NOT NULL AUTO_INCREMENT,
  `FK_idTYPEAPERO` int(11) NOT NULL,
  `FK_idBOISSON` int(11) NOT NULL,
  `quantiteBoisson` int(11) NOT NULL,
  PRIMARY KEY (`idTYPEAPERO_BOISSON`),
...
--
-- Table structure for table `UTILISATEUR_BRASSERIE`
--

DROP TABLE IF EXISTS `UTILISATEUR_BRASSERIE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `UTILISATEUR_BRASSERIE` (
  `idUTILISATEUR_BRASSERIE` int(11) NOT NULL AUTO_INCREMENT,
  `FK_idUTILISATEUR` int(11) NOT NULL,
  `FK_idBRASSERIE` int(11) NOT NULL,
  `dateCreation` datetime NOT NULL,
  PRIMARY KEY (`idUTILISATEUR_BRASSERIE`),
